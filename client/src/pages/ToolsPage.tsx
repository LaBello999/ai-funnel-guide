...
const tools = {
  en: [
    ...
    },
    {
      ...
      features: ['Email marketing', 'Automation', 'SMS marketing', 'Lead scoring'],
      price: 'From €27/month',
      affiliate: true,
    ...
    },
    {
      ...
      features: ['Email sequences', 'AI copywriting', 'Lead tracking', 'Outreach automation'],
      price: 'From $25/month',
      affiliate: true,
    ...
    },
    {
      ...
      features: ['Visual workflow builder', 'Complex automation', 'Reliable execution', 'Easy to learn'],
  ...
  de: [
    ...
    },
    {
      ...
      features: ['E-Mail-Marketing', 'Automation', 'SMS-Marketing', 'Lead-Scoring'],
      price: 'Ab €27/Monat',
      affiliate: true,
      affiliateUrl: 'https://www.klicktipp.com/?a=204688',
    },
    {
      ...
      features: ['E-Mail-Sequenzen', 'KI-Copywriting', 'Lead-Tracking', 'Outreach-Automation'],
      price: 'Ab €25/Monat',
      affiliate: true,
      affiliateUrl: 'https://instantly.ai/affiliate',
      note: 'Kommt bald - PartnerStack-Aktivierung läuft',
    },
    {
      ...
      features: ['Visueller Workflow-Builder', 'Komplexe Automation', 'Zuverlässige Ausführung', 'Einfach zu lernen'],
      price: 'Ab €9,99/Monat',
      affiliate: true,
